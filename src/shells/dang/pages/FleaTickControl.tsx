      ...
      <section className="px-4 md:px-10" style={{ paddingTop: '80px', paddingBottom: '60px', maxWidth: '1200px', margin: '0 auto', background: '#ffffff', backgroundImage: 'radial-gradient(circle, #d0d0d0 1px, transparent 1px)', backgroundSize: '24px 24px' }}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div>
            ...
            <h2 style={{ fontSize: 'clamp(26px, 2.8vw, 38px)', fontWeight: '800', marginBottom: '18px', marginTop: 0 }}>Flea & Tick Control Service</h2>
            <p style={{ fontSize: '16px', lineHeight: 1.75, marginBottom: '28px', color: '#444', marginTop: 0 }}>
              Fleas and ticks are more than just an annoyance—they're a threat to your family's comfort and enjoyment outdoors. At{' '}
              <a href="/" style={{ color: '#000', textDecoration: 'underline' }}>Dang Pest Control</a>, we provide professional flea and tick pest control services that effectively eliminate these pests and help you maintain a healthy, itch-free environment. Our customized treatments will eliminate any existing fleas and ticks and will also prevent future intrusions. We serve Tyler, TX, and the surrounding areas. Call us today at{' '}
