    ...
    <section className="bg-white py-12 border-b border-orange-100">
      <div className="container mx-auto px-4 grid md:grid-cols-3 gap-6 text-center items-start">
        ...
        <div className="flex flex-col items-center gap-4 px-6">
          <img src={dangSeal} alt="100% Super-Powered Guarantee" className="w-36 h-36 object-contain animate-float" />
        ...
        <div className="flex flex-col items-center gap-4 px-6">
          ...
          <div>
            <h3 className="text-comic text-xl mb-1" style={{color: 'hsl(20, 40%, 12%)'}}>Certified Expert</h3>
