...
export default function PestExterminationSection() {
  return (
    <section className="py-16" style={{ background: '#ffffff', backgroundImage: 'radial-gradient(circle, #d0d0d0 1px, transparent 1px)', backgroundSize: '24px 24px' }}>
      <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <Link to="/quote" className="inline-flex items-center justify-center font-bold rounded-full px-8 py-3 text-white transition-all hover:brightness-110"
            style={{ backgroundColor: 'hsl(28,100%,50%)', fontSize: '1rem' }}>
            Get Your Quote
          </Link>
        </div>
        <div>
          <img src="/exterior-treatment.jpg" alt="Pest Control Technician Applying Exterior Treatment" width="644" height="419"
