      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <div className="hidden lg:flex items-center gap-5 flex-1 justify-center">
            <div ref={dropdownRef} className="relative" onMouseEnter={onEnter} onMouseLeave={onLeave}>
              ...
              {dropdownOpen && (
                <div role="menu" className="absolute top-full left-0 mt-1 w-52 bg-white shadow-xl rounded-lg border border-gray-100 py-2 z-50">
                  {SERVICE_LINKS.map(l => (
                    <Link key={l.href} to={l.href} onClick={() => setDropdownOpen(false)}
            ...
            {NAV_LINKS.map(l => (
              <Link key={l.href} to={l.href} className="text-sm font-medium transition"
                style={{ color: '#1a1a1a' }}
                onMouseEnter={e => (e.currentTarget.style.color = 'var(--color-primary)')}
                onMouseLeave={e => (e.currentTarget.style.color = '#1a1a1a')}>
                {l.label}
          ...
          <div className="hidden lg:flex items-center gap-3 shrink-0">
            ...
            <Link to="/quote" className="font-bold rounded-full px-5 py-2.5 text-sm transition hover:opacity-90"
