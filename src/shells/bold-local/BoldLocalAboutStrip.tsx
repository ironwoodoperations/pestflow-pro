const FALLBACK_IMG = 'https://images.pexels.com/photos/8961421/pexels-photo-8961421.jpeg?auto=compress&cs=tinysrgb&w=800'
...
export default function BoldLocalAboutStrip({ businessName, intro, photoUrl }: Props) {
  const img = photoUrl || FALLBACK_IMG
    ...
    <section className="py-0" style={{ backgroundColor: '#f8f5f0' }}>
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2">
        <div className="h-72 md:h-auto overflow-hidden">
          <img src={img} alt={`${businessName} team`} className="w-full h-full object-cover" loading="lazy" />
        </div>
        <div className="px-8 py-14 flex flex-col justify-center">
          ...
          <a href="/contact" className="inline-block self-start font-bold rounded-full px-7 py-3 text-sm transition hover:opacity-90"
