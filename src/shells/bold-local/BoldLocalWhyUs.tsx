...
export default function BoldLocalWhyUs({ businessName, intro }: Props) {
  return (
    <section className="py-16 px-4" style={{ backgroundColor: '#ffffff' }}>
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
        ...
        <div>
          ...
          <a href="/contact" className="inline-block font-bold rounded-full px-7 py-3 transition hover:opacity-90"
