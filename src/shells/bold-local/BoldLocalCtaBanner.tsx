...
export default function BoldLocalCtaBanner({ phone }: Props) {
  return (
    <section className="py-16 px-4 text-center" style={{ backgroundColor: 'var(--color-primary)' }}>
      <div className="max-w-3xl mx-auto">
        ...
        <a href="/quote" className="inline-block font-bold rounded-full px-10 py-4 text-lg transition hover:opacity-90"
