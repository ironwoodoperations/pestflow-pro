...
export default function RusticRuggedCtaBanner({ phone }: Props) {
  return (
    <section className="py-14 px-4 text-center" style={{ backgroundColor: 'var(--color-primary)' }}>
      <div className="max-w-2xl mx-auto">
        ...
        <a href="/quote" className="inline-block font-bold rounded px-10 py-3 text-white transition hover:opacity-90"
