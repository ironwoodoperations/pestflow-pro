interface Props { businessName: string; onNext: () => void }

export default function StepWelcome({ businessName, onNext }: Props) {
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center space-y-6">
      <div className="w-16 h-16 bg-emerald-100 rounded-2xl flex items-center justify-center mx-auto">
        <span className="text-3xl">🏠</span>
      </div>
      <h2 className="text-2xl font-bold text-gray-900">Welcome to {businessName}!</h2>
