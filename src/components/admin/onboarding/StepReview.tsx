      ...
      <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 space-y-3">
        ...
        <div className="flex items-start gap-3">
          ...
          <label htmlFor="acceptedTerms" className="text-sm text-slate-700">
            ...
            <a href="https://pestflowpro.ai/terms" target="_blank" rel="noopener noreferrer" className="text-emerald-700 underline font-medium">
        ...
        <div className="flex items-start gap-3">
          ...
          <label htmlFor="acceptedPrivacy" className="text-sm text-slate-700">
            ...
            <a href="https://pestflowpro.ai/privacy" target="_blank" rel="noopener noreferrer" className="text-emerald-700 underline font-medium">
              Privacy Policy
            </a>
          </label>
        </div>
