      ...
      <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 space-y-3">
        ...
        <div className="flex items-start gap-3">
          ...
          <label htmlFor="acceptedTerms" className="text-sm text-slate-700">
            ...
            <a href="https://dangpestcontrol.com/terms-of-service" target="_blank" rel="noreferrer" className="text-emerald-700 underline font-medium">
        ...
        <div className="flex items-start gap-3">
          ...
          <label htmlFor="acceptedPrivacy" className="text-sm text-slate-700">
            ...
            <a href="https://dangpestcontrol.com/privacy-policy" target="_blank" rel="noreferrer" className="text-emerald-700 underline font-medium">
              Privacy Policy
            </a>
          </label>
        </div>
