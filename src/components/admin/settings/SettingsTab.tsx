...
function DomainSection() {
  ...
  const STEPS = [
    ...
    { num: 2, title: 'Enter your domain above', desc: 'Type your domain into the Custom Domain field above and click Save. This registers it in PestFlow Pro.' },
    { num: 3, title: 'Add domain in Vercel', desc: 'Go to your Vercel project → Settings → Domains → Add Domain. Enter the same custom domain.' },
    ...
    { num: 5, title: 'Wait for SSL', desc: 'Vercel automatically provisions a free SSL certificate. This usually takes 1-5 minutes after DNS propagation.' },
