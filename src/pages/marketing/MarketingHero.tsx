    ...
    <section style={{
      ...
      <div style={{ position: 'relative', textAlign: 'center', maxWidth: 780 }}>
        ...
        <div style={{
          ...
          {STATS.map(s => (
            <div key={s.label}>
              <p style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: 22, color: C.text, margin: 0 }}>{s.val}</p>
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: C.muted, margin: '4px 0 0' }}>{s.label}</p>
            </div>
          ))}
        </div>
      </div>
