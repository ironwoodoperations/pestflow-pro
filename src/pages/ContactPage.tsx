    ...
    resolveTenantId().then(async (tid) => {
      ...
      if (data) {
        for (const row of data) {
          if (row.key === 'business_info' && row.value) {
            setInfo({
              name: row.value.name || 'PestFlow Pro',
              phone: row.value.phone || '(903) 555-0100',
      ...
      <section className="bg-gray-950 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 text-lg">
            ...
            <a href={`tel:${info.phone}`} className="text-orange-400 font-bold hover:underline">{info.phone}</a>
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <form onSubmit={handleSubmit} className="lg:col-span-2 bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-gray-900 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none"
                    required
                  />
                </div>
                <div>
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  rows={5}
                  className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-gray-900 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none resize-none"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={submitting}
                className={`w-full ${tokens.buttonClass} text-lg py-4 disabled:opacity-50`}
              >
            ...
            <div className="bg-gray-900 text-white rounded-xl p-6">
              <h3 className="font-bangers tracking-wide text-xl text-orange-400 mb-4">Get in Touch</h3>
              ...
              {(social.facebook || social.instagram || social.google) && (
                <div className="mt-6 pt-4 border-t border-gray-700">
                  ...
                  <div className="flex gap-3">
                    {social.facebook && (
                      <a href={social.facebook} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">Facebook</a>
                    )}
                    {social.instagram && (
                      <a href={social.instagram} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">Instagram</a>
                    )}
                    {social.google && (
                      <a href={social.google} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">Google</a>
                    )}
                  </div>
                </div>
              )}
