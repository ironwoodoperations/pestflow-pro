...
export default function QuotePage() {
  ...
  function togglePest(pest: string) {
    setForm((prev) => ({
      ...prev,
      pests: prev.pests.includes(pest)
        ? prev.pests.filter((p) => p !== pest)
        : [...prev.pests, pest],
    }))
  }
    ...
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-2xl mx-auto px-4 py-24 text-center">
          ...
          <p className="text-gray-500">Need immediate help? Call us at <a href={`tel:${businessPhone}`} className="text-orange-600 font-bold hover:underline">{businessPhone}</a></p>
        </div>
        <Footer />
      </div>
    )
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <h1 className="font-bangers tracking-wide text-4xl md:text-5xl text-gray-900 text-center mb-2">
            Get a Free Quote
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              <div className="bg-gray-900 text-white rounded-xl p-6">
                <h3 className="font-bangers tracking-wide text-xl text-orange-400 mb-3">{businessName}</h3>
                <a href={`tel:${businessPhone}`} className="text-2xl font-bold text-white hover:underline block mb-4">
                  {businessPhone}
                </a>
