// Platform-level Privacy Policy. Rendered at apex /privacy.
...
export const PRIVACY_LAST_UPDATED = '2026-05-09';

export const PRIVACY_CONTENT = `# Privacy Policy

_PestFlow Pro Platform — How We Collect, Use, and Protect Your Data_

_Last Updated: May 9, 2026_

This Privacy Policy describes how Ironwood Operations Group LLC ("Provider," "we," "us") collects, uses, and protects information in connection with the PestFlow Pro platform ("Platform"). This policy applies to Platform subscribers (pest control and home services businesses) and their end customers.
...
All Platform data is stored in Supabase (a SOC 2 compliant cloud database provider). Data is encrypted in transit (TLS) and at rest. Access is controlled via row-level security policies. We implement industry-standard security practices, but no system is 100% secure.
...
- **Stripe:** Payment processing for subscription billing and setup fees
...
- **Zernio:** Multi-platform social media publishing when you connect your social accounts
- **Facebook / Meta:** Social post publishing when you connect your Facebook Page directly
...
We retain your data for as long as your subscription is active. Upon termination: (a) you may export all Client Content within 60 days; (b) after 60 days, your data may be deleted from our systems; (c) backups may persist for up to 90 days after deletion.
...
Client websites built on the Platform may use Google Analytics 4 if configured by the subscriber. Analytics data is governed by Google's Privacy Policy. We do not set tracking cookies on admin dashboard sessions beyond what is necessary for authentication.

## 9. Children's Privacy

The Platform is not intended for use by children under 13. We do not knowingly collect data from children. If you believe a child has submitted data through a client website, contact us immediately.

## 10. Changes to This Policy

We may update this Privacy Policy with reasonable notice. The "Last Updated" date at the top indicates the most recent revision. Continued use of the Platform after changes constitutes acceptance.
