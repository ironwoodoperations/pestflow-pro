// Platform-level Terms of Service & EULA. Rendered at apex /terms.
// Format: extended-markdown subset (#, ##, **bold**, _italic_, - bullets,
// blank-line paragraph breaks). Parsed by ../../pages/legal/_lib/legalMarkdown.tsx.

export const TERMS_LAST_UPDATED = '2026-05-09';

export const TERMS_CONTENT = `# Terms of Service & End User License Agreement

_PestFlow Pro Platform — Effective upon electronic acceptance_

_Last Updated: May 9, 2026_

**PLEASE READ THESE TERMS CAREFULLY BEFORE ACCESSING THE PESTFLOW PRO PLATFORM. BY CHECKING THE ACCEPTANCE BOX DURING ONBOARDING, YOU AGREE TO BE LEGALLY BOUND BY THESE TERMS.**

## 1. Acceptance of Terms

These Terms of Service ("Terms") constitute a legally binding agreement between Ironwood Operations Group LLC ("Provider," "we," "us") and you ("Client," "you"). By electronically accepting these Terms during the onboarding process, you agree to all terms contained herein. If you do not agree, do not proceed with onboarding.

## 2. The Platform

PestFlow Pro is a white-label SaaS platform that provides pest control and home services businesses with a professional website, lead management CRM, SEO tools, social media scheduling, AI content generation, and business management features. Access is provided via a subscription model as described in Section 6.
...
Subject to payment of applicable fees, Provider grants you a limited, non-exclusive, non-transferable, revocable license to access and use the Platform for your internal business purposes only. You may not sublicense, resell, or white-label the Platform to any third party.
...
5.3 All website shell designs (Modern Pro, Bold & Local, Clean & Friendly, Rustic & Rugged, Metro Pro, YouPest, and any future template designs introduced by Provider) are Provider's proprietary Template Designs and are not transferred to you under any circumstances.

## 6. Subscription Fees

The Platform is offered on the following monthly subscription tiers:

- **Starter — $149/month:** Website, CRM, basic SEO, locations (up to 3), team management
- **Grow — $249/month:** All Starter features plus full SEO suite, blog, social scheduling
- **Pro — $349/month:** All Grow features plus AI tools, advanced reports, campaigns
- **Elite — $499/month:** All Pro features plus social analytics, multi-platform publishing, live reviews

A one-time setup fee, ranging from $0 to $10,000 depending on tier and scope agreed at onboarding, is due before Platform provisioning. Monthly fees are billed on the first of each month. Non-payment within ten (10) days may result in suspension.
...
The Platform integrates with third-party services including but not limited to: Supabase (database), Vercel (hosting), Resend (email delivery), Textbelt (SMS), Zernio (multi-platform social media publishing), Anthropic (AI content generation), Stripe (payment processing), Facebook Graph API (direct Facebook publishing), and Google APIs (Analytics, Maps, Search Console). Your use of these integrations is also subject to those providers' terms of service. Provider is not responsible for third-party service outages or policy changes.

## 12. Service Availability

Provider will use commercially reasonable efforts to maintain 99% uptime. Provider is not liable for downtime caused by third-party infrastructure, scheduled maintenance, or circumstances beyond Provider's control (force majeure).

## 13. Termination

Either party may terminate with thirty (30) days written notice. Provider may terminate immediately for cause including non-payment, AUP violations, or fraudulent activity. Upon termination, Platform access ceases and data export rights apply per Section 10.3.
...
TO THE MAXIMUM EXTENT PERMITTED BY LAW, PROVIDER'S TOTAL LIABILITY SHALL NOT EXCEED AMOUNTS PAID BY CLIENT IN THE THREE (3) MONTHS PRECEDING THE CLAIM. PROVIDER IS NOT LIABLE FOR INDIRECT, INCIDENTAL, CONSEQUENTIAL, SPECIAL, OR PUNITIVE DAMAGES.

## 16. Indemnification

You agree to indemnify and hold harmless Ironwood Operations Group LLC, its officers, employees, and agents from any claims, damages, or expenses (including attorney's fees) arising from: (a) your use of the Platform in violation of these Terms; (b) your violation of any applicable law; (c) your infringement of any third-party rights; or (d) any content you publish through the Platform.
...
These Terms are governed by the laws of the State of Texas. Any disputes shall be resolved in Cherokee County, Texas. You waive any objection to jurisdiction or venue in such courts.

## 19. Modifications

Provider may update these Terms with thirty (30) days notice via email. Continued use of the Platform after the effective date of changes constitutes acceptance. If you object to changes, your sole remedy is to terminate your subscription.
