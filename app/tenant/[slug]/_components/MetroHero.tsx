...
export function MetroHero({ tenant, content, heroMedia, heroImageUrl = null }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center py-20 w-full">
        ...
        {hasVideo && posterUrl && (
          <div className="max-w-2xl mx-auto rounded-lg overflow-hidden border border-white/20">
            <VideoPosterPlayer posterUrl={posterUrl} youtubeId={youtubeId || undefined} videoUrl={videoUrl || undefined} playButtonColor="rgba(10,22,40,0.92)" aspectRatio="16 / 9" />
          </div>
        )}
      </div>
    </section>
