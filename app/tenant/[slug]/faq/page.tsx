...
export async function generateMetadata({ params }: Params): Promise<Metadata> {
  ...
  const seoMeta = await getSeoMeta(tenant.id, 'faq');
  return buildPageMetadata(tenant, {
    pathname: '/faq',
    seoMeta,
    fallback: {
      title: `FAQ | ${businessName}`,
      description: `Answers to common questions about ${businessName} and our services.`,
    },
  });
}
...
import { getPageContent, getHeroMedia, getSeoMeta } from '../_lib/queries';
