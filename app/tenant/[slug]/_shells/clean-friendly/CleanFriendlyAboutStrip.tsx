...
export function CleanFriendlyAboutStrip({ businessName, intro, foundedYear, techCount, imageUrl }: Props) {
  const stats = [
    ...
    <section className="py-16 px-6 bg-white">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <Link href="/about" className="inline-block px-6 py-3 rounded-lg font-semibold text-sm"
        ...
        <div>
          {imageUrl ? (
            ...
            <div className="w-full h-80 rounded-2xl shadow-md flex items-center justify-center"
              ...
              <div className="w-16 h-16 rounded-full opacity-20" style={{ background: 'var(--color-primary)' }} />
            </div>
          )}
        </div>
      </div>
